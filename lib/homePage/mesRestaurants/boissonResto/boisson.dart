...
class BoissonHomePage extends StatefulWidget {

   String? userNameChef ;
   Restaurant? resto ;

   BoissonHomePage({Key? key, this.userNameChef, this.resto}) : super(key: key);

  @override
  State<BoissonHomePage> createState() => _BoissonHomePageState();
}

class _BoissonHomePageState extends State<BoissonHomePage> {
                        ...
                        children: snapshot.data!.docs.map((DocumentSnapshot document) {
                          ...
                          if(FirebaseAuth.instance.currentUser!.uid == produit.userUID  &&
                             // produit.cartegory == this.widget.resto!.cartegory &&
                              produit.type.toString() == Chaines.CONST_PRODUIT_BOISSON && produit.uidRestaurant == this.widget.resto!.uid)
                              ...
                              GestureDetector(
                                ...
                                child: Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    leading: const Icon(Icons.wine_bar_rounded/*, color: Colors.amber*/ , size: 30,),
  ...
  void deleteProduit ({required String uidProduitPanier})
  {
    FirebaseFirestore.instance.collection(Collections.collectionProduits)
      ...
      Fluttertoast.showToast(msg: "Boisson supprimer",
        backgroundColor: Colors.green,
        textColor: Colors.white,
        fontSize: 15,
        toastLength: Toast.LENGTH_LONG,);

      print("Boisson supprimer");
    })
