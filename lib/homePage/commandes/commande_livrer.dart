import 'package:assouka_chef/homePage/detailProductCommande.dart';
...
class Commande_livrerPage extends StatefulWidget {

  String? userNameChef ;
  Restaurant? resto ;
   Commande_livrerPage({Key? key, this.resto, this.userNameChef}) : super(key: key);

  @override
  _Commande_livrerPageState createState() => _Commande_livrerPageState();
}

class _Commande_livrerPageState extends State<Commande_livrerPage> {
                            ...
                            return
                              ...
                              Card(
                                ...
                                child: ListTile(
                                  ...
                                  leading: const Icon(Icons.agriculture_outlined/*, color: Colors.amber*/ , size: 30,),
